 ...
 */
final class Version20200624173948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE drug (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recurrence (id INT AUTO_INCREMENT NOT NULL, drug_id INT NOT NULL, morning INT NOT NULL, noon INT NOT NULL, evening INT NOT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, UNIQUE INDEX UNIQ_1FB7F221AABCA765 (drug_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE recurrence ADD CONSTRAINT FK_1FB7F221AABCA765 FOREIGN KEY (drug_id) REFERENCES drug (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recurrence DROP FOREIGN KEY FK_1FB7F221AABCA765');
